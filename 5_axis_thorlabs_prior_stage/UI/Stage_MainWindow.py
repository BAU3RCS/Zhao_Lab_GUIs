...
class Stage_MainWindow(QMainWindow):
    ...
    def __init__(self, commands:device_commands, prior_stage):
        ...
        self.x_row[2].setPlaceholderText("500")
        self.x_row[2].setText("500")
        ...
        self.y_row[2].setPlaceholderText("500")
        self.y_row[2].setText("500")
        ...
        self.z_big_step.setPlaceholderText("100")
        self.z_big_step.setText("100")
        ...
        self.z_small_step.setPlaceholderText("50")
        self.z_small_step.setText("50")
