...
class priorGUI(QWidget):
    ...
    def interface(self):
        ...
        self.step_size_spinbox.setRange(0, int(self.stage.x_lim / 2)) 
    ...
    def connect_hardware(self, checked):
        ...
        if checked:
            self.stage.connect(self.devport)
    ...
    def move_up(self):
        self.stage.move_rel(0, self.step_size)
